...
from bot_settings.bot_config import token, token_test, user_id, irk_ru_url

from scripts.irk_news import get_all_irk_news, check_irk_news_update
...
async def get_last_five_irk_news(message: types.Message):
    logging.info('[INFO] | Get last 5 news.')
